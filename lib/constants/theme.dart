...
var darkTheme = const ColorScheme(
  ...
  secondaryContainer: Color(0xffff7263),
...
var lightTheme = const ColorScheme(
  ...
  onPrimary: Color(0xffffffff),
  secondary: Color(0xffff3838),
  secondaryContainer: Color(0xffc4000f),
  onSecondary: Color(0xffffffff),
...
final ThemeData myLightTheme = ThemeData(
    ...
    indicatorColor: const Color(0xffff3838),
    toggleableActiveColor: const Color(0xffff3838));